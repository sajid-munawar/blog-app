...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference("Like.count") do
      post likes_url, params: { like: { created_at: @like.created_at, updated_at: @like.updated_at } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { created_at: @like.created_at, updated_at: @like.updated_at } }
